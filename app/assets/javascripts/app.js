...
angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives', 'myApp.controllers', 'firebase', 'ui.bootstrap']).
  config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/support-bilal-ayyub', {templateUrl: 'endorse-bilal-ayyub.html', controller: 'MyCtrl1'});
    $routeProvider.when('/bilal-ayyub-biography', {templateUrl: 'bio.html'});
    $routeProvider.when('/bilal-ayyub-home', {templateUrl: 'home.html', controller: 'NewsCtrl'});
    ...
    $routeProvider.otherwise({redirectTo: '/bilal-ayyub-home'});
  }]);
